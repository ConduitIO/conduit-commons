...
var parameterTypeConstantMapping = map[config.ParameterType]string{
	...
	config.ParameterTypeFloat:    "ParameterTypeFloat",
	config.ParameterTypeBool:     "ParameterTypeBool",
	config.ParameterTypeFile:     "ParameterTypeFile",
	config.ParameterTypeDuration: "ParameterTypeDuration",
}

type parameter config.Parameter
...
func (p parameter) GetValidation(index int) string {
	...
	regexValidation, ok := validation.(config.ValidationRegex)
	if !ok {
		// default behavior
