...
var file_opencdc_v1_opencdc_proto_extTypes = []protoimpl.ExtensionInfo{
	...
	},
	{
		...
		ExtensionType: (*string)(nil),
		Field:         10004,
		Name:          "opencdc.v1.metadata_key_schema_name",
		Tag:           "bytes,10004,opt,name=metadata_key_schema_name",
		Filename:      "opencdc/v1/opencdc.proto",
	},
	{
		ExtendedType:  (*descriptorpb.FileOptions)(nil),
	...
	},
	{
		...
		ExtensionType: (*string)(nil),
		Field:         10006,
		Name:          "opencdc.v1.metadata_key_schema_type",
		Tag:           "bytes,10006,opt,name=metadata_key_schema_type",
		Filename:      "opencdc/v1/opencdc.proto",
	},
	{
		ExtendedType:  (*descriptorpb.FileOptions)(nil),
		ExtensionType: (*string)(nil),
		Field:         10007,
		Name:          "opencdc.v1.metadata_payload_schema_name",
		Tag:           "bytes,10007,opt,name=metadata_payload_schema_name",
		Filename:      "opencdc/v1/opencdc.proto",
	},
	{
		ExtendedType:  (*descriptorpb.FileOptions)(nil),
		...
		Tag:           "bytes,10008,opt,name=metadata_payload_schema_version",
		Filename:      "opencdc/v1/opencdc.proto",
	},
	{
		ExtendedType:  (*descriptorpb.FileOptions)(nil),
		ExtensionType: (*string)(nil),
		Field:         10009,
		Name:          "opencdc.v1.metadata_payload_schema_type",
		Tag:           "bytes,10009,opt,name=metadata_payload_schema_type",
		Filename:      "opencdc/v1/opencdc.proto",
	},
}
...
var (
	...
	// Metadata field "opencdc.key.schema.name" contains the name of the schema of
	// the record's .Key field.
	//
	// optional string metadata_key_schema_name = 10004;
	E_MetadataKeySchemaName = &file_opencdc_v1_opencdc_proto_extTypes[5]
	...
	// Metadata field "opencdc.key.schema.type" contains the type of the schema of
	// the record's .Key field (currently, the only supported value is "avro")
	//
	// optional string metadata_key_schema_type = 10006;
	E_MetadataKeySchemaType = &file_opencdc_v1_opencdc_proto_extTypes[7]
	// Metadata field "opencdc.payload.schema.name" contains the name of the schema of
	// the record's .Payload fields.
	//
	// optional string metadata_payload_schema_name = 10007;
	E_MetadataPayloadSchemaName = &file_opencdc_v1_opencdc_proto_extTypes[8]
	// Metadata field "opencdc.payload.schema.version" contains the version of the schema of
	// the record's .Payload fields.
	//
	// optional string metadata_payload_schema_version = 10008;
	E_MetadataPayloadSchemaVersion = &file_opencdc_v1_opencdc_proto_extTypes[9]
	// Metadata field "opencdc.payload.schema.type" contains the type of the schema of
	// the record's .Payload fields (currently, the only supported value is "avro")
	//
	// optional string metadata_payload_schema_type = 10009;
	E_MetadataPayloadSchemaType = &file_opencdc_v1_opencdc_proto_extTypes[10]
)
...
var file_opencdc_v1_opencdc_proto_rawDesc = []byte{
	...
	0x6f, 0x6c, 0x6c, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x3a, 0x56, 0x0a, 0x18, 0x6d, 0x65, 0x74,
	...
	,
...
var file_opencdc_v1_opencdc_proto_depIdxs = []int32{
	...
	6,  // 12: opencdc.v1.metadata_key_schema_name:extendee -> google.protobuf.FileOptions
	6,  // 13: opencdc.v1.metadata_key_schema_version:extendee -> google.protobuf.FileOptions
	6,  // 14: opencdc.v1.metadata_key_schema_type:extendee -> google.protobuf.FileOptions
	6,  // 15: opencdc.v1.metadata_payload_schema_name:extendee -> google.protobuf.FileOptions
	6,  // 16: opencdc.v1.metadata_payload_schema_version:extendee -> google.protobuf.FileOptions
	6,  // 17: opencdc.v1.metadata_payload_schema_type:extendee -> google.protobuf.FileOptions
	18, // [18:18] is the sub-list for method output_type
	18, // [18:18] is the sub-list for method input_type
	18, // [18:18] is the sub-list for extension type_name
	7,  // [7:18] is the sub-list for extension extendee
