...
var (
	...
	ErrLessThanOrEqualValidationFail    = errors.New("less-than-or-equal validation failed")
	ErrGreaterThanOrEqualValidationFail = errors.New("greater-than-or-equal validation failed")
)
